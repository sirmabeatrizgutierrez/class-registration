...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 02, 2023 at 10:53 AM
...
-- Procedures
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `SP_Add_Class` (IN `InputCourseID` INT, IN `InputInstructorID` INT, IN `InputRoomID` INT, IN `InputSchedule` VARCHAR(50))   BEGIN INSERT INTO product (CourseID, InstructorID, RoomID, Schedule) VALUES (InputCourseID, InputInstructorID, InputRoomID, InputSchedule); END$$
